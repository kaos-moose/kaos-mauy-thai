...
export default function CharterFormSection() {
  ...
  return (
    <section id="charter-form" className="relative py-24 px-4 overflow-hidden">
      <Image
        src="/section-5.jpg"
        fill
        alt=""
      ...
      <div className="relative z-10 max-w-lg mx-auto bg-white/90 px-8 md:px-12 py-14">
        <div className="text-center mb-10">
          <div className="inline-block bg-red-600 text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1 mb-4">
            Limited — 25 Spots · Closes July 18th
          </div>
          <h2
        ...
        {status === "success" ? (
          <div className="border border-red-600/30 bg-red-50 p-10 text-center">
            ...
            <p className="text-neutral-500">
              We&apos;ll reach out shortly to confirm your Charter spot. Welcome aboard.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-2">
              <button
                ...
                style={{ fontFamily: "var(--font-display)" }}
              >
                {status === "loading" ? "Submitting…" : "Claim Charter Spot"}
              </button>
            </div>
          </form>
        )}
