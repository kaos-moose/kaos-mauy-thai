const consequences = [
  "Charter rate ends — regular pricing applies",
  "Preview class access closes",
  "Early schedule registration closes",
];
    ...
    <section className="bg-neutral-950 py-20 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="border border-red-600/50 bg-red-950/10 p-10 md:p-14 text-center">
          ...
          <p className="text-neutral-400 text-lg mb-8">When all 25 are claimed:</p>
          ...
          <p className="text-red-400 font-bold text-sm uppercase tracking-widest mb-8">
            Charter closes July 18th — or when spots fill.
          </p>
